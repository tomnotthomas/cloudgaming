...
exports.getSteamId = exports.getSteamGames = void 0;
const express = require('express');
const fetch = require('cross-fetch');
const dotenv = require('dotenv');
const User = require('../models/User');
dotenv.config();
const getSteamId = async (req, res) => {
  try {
    const steamIdString = req.query['openid.claimed_id'];
    const steamId = steamIdString.substring(steamIdString.length - 17);
    const email = req.user.userEmail; // Casting to 'any' as req.user doesn't have type 'User'
